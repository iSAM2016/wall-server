...
class Performance extends parseBase_1.default {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (let [[projectId, url, indicator, countAtMinute], uniqIdMap] of this
                    ...
                    let oldRecordList = yield this.performanceService.getRecordList(projectId, url, indicator, countAt, config_1.UNIT.MINUTE);
                    let id = _.get(oldRecordList, [0, 'id'], 0);
                    let isSuccess = yield this.checkSaveCount(url, countAt, indicator, pvTotal, projectId, config_1.UNIT.MINUTE, oldRecordList, cityDistribute, sumIndicatorValueTotal);
    ...
    checkSaveCount(url, countAt, indicator, pv, projectId, countType, oldRecordList, cityDistribute, sumIndicatorValue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let isSuccess = false;
            if (id > 0) {
                isSuccess = yield this.updateCityDistribution(id, data, projectId, countAt, createTimeInDb, cityDistribute, cityDistributeIdInDb);
            }
            else {
    ...
    updateCityDistribution(id, data, projectId, countAt, createTimeInDb, cityDistribute, cityDistributeIdInDb) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let affectRows = yield this.performanceService.updatePerformance(id, data, projectId, countAt);
            return affectRows > 0;
        });
    }
    insertCityDistributionRecord(cityDistribute, data, projectId, updateAt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let insertResult = yield this.performanceService.insertPerformance(data, projectId, updateAt);
