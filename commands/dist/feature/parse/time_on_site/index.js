...
class TimeOnSiteByHour extends parseBase_1.default {
            ...
            try {
                ...
                for (let [projectId, countAtMap] of this.projectMap) {
                    for (let [countAtTime, distribution] of countAtMap) {
                        ...
                        let totalUv = yield this.uniqueViewService.getTotalUv(projectId, countAtTime, config_1.UNIT.HOUR);
                        let oldRecordList = yield this.durationDistributionService.replaceUvRecord(projectId, countAtTime, config_1.UNIT.HOUR);
                        let isSuccess = yield this.checkSaveCount(totalUv, oldRecordList, projectId, countAtTime, distribution, totalStayMs);
    ...
    checkSaveCount(totalUv, oldRecordList, projectId, countAtTime, cityDistribute, totalStayMs) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateCityDistribution(id, data, projectId, createTimeInDb, cityDistribute, cityDistributeIdInDb) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let affectRows = yield this.durationDistributionService.updateDuration(id, data);
            return affectRows > 0;
        });
    }
    insertCityDistributionRecord(cityDistribute, data, projectId, updateAt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let insertResult = yield this.durationDistributionService.insertDuration(data);
