...
class TaskManger extends commandsBase_1.default {
    ...
    claoseOtherTaskManger() {
        return __awaiter(this, void 0, void 0, function* () {
            let taskManagerPidList = yield this.getOtherTaskMangerPidList();
    ...
    dispatchParseCommand(commandName, startAtStr, endAtStr) {
        return __awaiter(this, void 0, void 0, function* () {
