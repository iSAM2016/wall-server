...
class WatchAlarm extends commandsBase_1.default {
    ...
    handle(args, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const alarmConfigList = yield this.watchService.getAllEnabled();
                for (let alarmConfig of alarmConfigList) {
                    ...
                    const hasAlertInAlarmInterval = yield this.redisClient.asyncGet(redisKey);
                        ...
                        while (waitForDispatch) {
                            if (this.currentQueryCounter < MAX_QUERY_COUNT) {
                                ...
                                if (sleepCounter > MAX_SLEEP_COUNT) {
                                    ...
                                    yield this.alert.sendMessage(`报警系统数据库查询已经睡眠${sleepMinutes}分钟，可能出问题了。`);
                                }
    ...
    autoAlarm(projectId, errorName, timeRange, maxErrorCount, alarmInterval, redisKey, note, configId) {
        return __awaiter(this, void 0, void 0, function* () {
