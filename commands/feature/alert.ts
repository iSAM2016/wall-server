...
//     let ucid: string | number = `${rawUcid}`;
//     if (ucid.length > 10) {
...
//     let totalCount = parseInt(String(message.length / MAX_CONTENT_CHAR)) + 1;
//     let lastIndex = 1;
//     for (; lastIndex <= totalCount; lastIndex = lastIndex + 1) {
//       let subContent = message.substring(
//         MAX_CONTENT_CHAR * (lastIndex - 1),
//         MAX_CONTENT_CHAR * lastIndex,
//       );
